    ...
    return (
        <div className="info">
            <div className="info-title">
                ...
                <p className="info-title-string">リアルタイムマップ東北応援企画</p>
            </div>
            <div className="info-divider"></div>
            <div className="info-body">
                <span className="info-text-plain">{INFO_CONTENT_PLAIN1_PART1}
                <a href={INFO_CONTENT_LINK1}>{INFO_MAPBOX_JP}</a>
                {INFO_CONTENT_PLAIN1_PART2}</span>
